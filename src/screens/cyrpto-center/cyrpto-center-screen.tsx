...
export const CyrptoCenterScreen = ({
  trendData,
  accountData,
}: {
  trendData: any;
      ...
      <Box sx={{ ...BOX }}>
        <Grid sx={{ pb: 2, px: 2 }} spacing={2} container>
          ...
          <Grid
            ...
            xs={12}
          >
            <Typography sx={TEXT} component={"h2"} variant={"h5"}>
              A Hunters Dream (CAW) token was recently listed on 8 exchanges in
              total.
            </Typography>
