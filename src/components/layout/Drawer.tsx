    ...
    >
      ...
      >
        <Box
          display={"flex"}
          alignItems={"center"}
          sx={{ marginTop: "17px", marginBottom: "21.57px" }}
        >
          <Box
            component={"img"}
        ...
        <ListItem sx={ITEM} disablePadding>
          ...
          >
            <ListItemIcon>
              <i style={ITEM_ICON} className="fa-solid fa-plus"></i>
            </ListItemIcon>
          ...
          {account && (
            <>
              ...
              >
                <ListItemIcon>
                  <i
                    style={{ ...ITEM_ICON, color: "red" }}
                    className="fa-solid fa-arrow-right-from-bracket"
                  ></i>
                </ListItemIcon>
                <Typography sx={{ ...ITEM_TEXT, color: "red" }}>
                  Logout
                </Typography>
              </ListItemButton>
            </>
