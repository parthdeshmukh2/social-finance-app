...
const ACTIVE = {
  position: "absolute",
  backgroundColor: "krmrPlate.themeBg",
  height: "45px",
  zIndex: "-1",
  marginLeft: "-10px",
  marginTop: "-9px",
...
const MENU_ITEM = {
  ...
  fontWeight: "500",
  color: "krmrPlate.themeMenuItemColor",
  marginLeft: "10px",
  marginBottom: "18px",
};
        ...
        <Box sx={{ display: "flex" }}>
          ...
          <Typography sx={MENU_ITEM}>
            <img
              ...
              src={
                route === imageName
                  ? "assets/img/caw_direct_text_selected.png"
                  : name
              }
            />
          </Typography>
    ...
    <Box key={Math.random() * 10000} sx={ITEMS} component={"button"}>
      ...
      <Box sx={{ display: "flex", height: "auto" }}>
        <i
          style={
            route === name
              ? { ...MENU_ICON, color: plate.menuItemColor }
              : {
                  ...MENU_ICON,
                  color: plate.themeMenuItemColor,
                }
          }
          className={icon}
        ></i>
        <Typography
          sx={
            route === name
              ? { ...MENU_ITEM, color: plate.menuItemColor }
              : {
                  ...MENU_ITEM,
                  color: "krmrPlate.themeMenuItemColor",
                }
